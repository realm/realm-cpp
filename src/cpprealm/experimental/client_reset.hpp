#ifndef CPPREALM_EXPERIMENTAL_CLIENT_RESET_HPP
#define CPPREALM_EXPERIMENTAL_CLIENT_RESET_HPP
...
namespace realm {
    ...
    namespace client_reset {
        ...
        struct manual : internal::bridge::client_reset_mode_base<experimental::db> {
            explicit manual();
        };
        ...
        struct discard_unsynced_changes : internal::bridge::client_reset_mode_base<experimental::db> {
        ...
        /// - parameter before: A callback which passes a frozen copy of the local Realm state prior to client reset.
        /// - parameter after: A callback which passes a frozen copy of the local Realm and a live instance of the remote Realm after client reset.
        struct recover_unsynced_changes : internal::bridge::client_reset_mode_base<experimental::db> {
        ...
        /// - parameter before: A callback which passes a frozen copy of the local Realm state prior to client reset.
        /// - parameter after: A callback which passes a frozen copy of the local Realm and a live instance of the remote Realm after client reset.
        struct recover_or_discard_unsynced_changes : internal::bridge::client_reset_mode_base<experimental::db> {
