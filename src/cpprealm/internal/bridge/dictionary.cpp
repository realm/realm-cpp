...
namespace realm::internal::bridge {
    ...
    void dictionary::insert_list(const std::string& key) {
        get_dictionary()->insert_collection(PathElement(key), CollectionType::List);
    }
    list dictionary::get_list(const std::string& key) {
        return get_dictionary()->get_list(key);
    }
