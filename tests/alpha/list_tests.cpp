...
TEST_CASE("list", "[list]") {
   ...
   SECTION("list_insert_remove_primitive") {
       ...
       CHECK(obj.list_int_col.size() == 2);
       CHECK(obj.list_int_col.find(1) == realm::not_in_collection);
   ...
   SECTION("list_insert_remove_object") {
       ...
       CHECK(obj.list_obj_col.find(o4) == realm::not_in_collection);
       ...
       CHECK(obj.list_obj_col.size() == 4);
       CHECK(obj.list_obj_col.find(o5) == realm::not_in_collection);
   ...
   SECTION("list_insert_remove_embedded_object") {
       ...
       CHECK(obj.list_embedded_obj_col.find(o4) == realm::not_in_collection);
       ...
       CHECK(obj.list_embedded_obj_col.size() == 4);
       CHECK(obj.list_embedded_obj_col.find(o5) == realm::not_in_collection);
